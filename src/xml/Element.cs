...
public class Element : Node
{
    ...
    {
        get => elements ??= new Elements(InternalNode);
    }

    private Filer AttributesFiler
    {
        get => attributesFiler ??= Attributes.Filer;
    }

    public Filer Filer
    {
        get => filer ??= new ElementFiler(InternalNode);
    }

    internal XmlElement InternalElement
    {
        get => (XmlElement)Controller;
    }

    public static implicit operator Element(XmlElement element) => new Element(element);

    public static implicit operator XmlElement(Element element) => element.InternalElement;
